...
#iChannel0 "file://channel0.png"
#iChannel1 "file://channel1.png"

// PBR BRDF 模型：NDF、geomrtry、菲涅尔
// 1.NDF：统计与半程向量取向一致的微平面(的法线)的比率
...
// 2.geometry : 几何遮蔽，微平面互相遮蔽的比率；
// 除与粗糙度有关外，还与nol(光线射入微平面被遮挡)、nov(视线观察微平面被遮挡)有关；
