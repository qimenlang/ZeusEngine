...
int main() {
    ...
    // std::filesystem::path(GET_ZEUS_STR(ZEUS_ROOT_DIR));
    // zeus::EngineInitParams zeus_init_paras; zeus_init_paras.m_root_folder =
    // zeus_root_folder; zeus_init_paras.m_config_file_path = zeus_root_folder /
    // "ZeusEditor.ini";
